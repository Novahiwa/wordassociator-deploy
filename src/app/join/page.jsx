  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-300 via-purple-300 to-pink-300 p-6">
     {join ?  <form
      ...
      </form> : <div className="bg-white p-8 md:p-12 rounded max-w-[400px] shadow">
        <h1 className="text-2xl font-bold text-red-500 mb-4">Applications Closed</h1>
        <p className="text-[var(--dark)] mb-4">Thank you to everyone who applied to join the Word Associator Dev Team. The application process is now complete and all submissions have been processed. Selected applicants will receive an email soon with the next steps.</p>
<p className="text-[var(--dark)]">
We appreciate your interest and encourage you to stay connected for future opportunities.</p>
        </div>}
    </div>
  );
};
